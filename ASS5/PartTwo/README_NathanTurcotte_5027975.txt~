...
Part 1 : Using SSH
    Located in directory ASS5 of repository CS3130
    within file named PartOne
    https://github.com/NathanTurcotte/CS3130

Part 2 : SSL encryption
    Located in Directory ASS5, subfolder PartTwo, of repository CS3130
    https://github.com/NathanTurcotte/CS3130

Requires python 3.4
Added SSL data encryption
